      ...
      <form method="POST" action="http://<?=APP_HOST?>/produto/cadastrar" enctype="multipart/form-data">
        ...
        <div class="row mb-3">
          <div class="col-6 col-md-4 col-lg-3">
            ...
            <input type="text" class="form-control border border-primary" id="preco" name="preco" required>
          </div>
        </div>
        <div class="row mb-3">
          <div class="col-6 col-md-4 col-lg-3">
            <label for="estoque" class="form-label">Estoque</label>
            <input type="number" min="0" class="form-control border border-primary" id="estoque" name="estoque" required>
          </div>
        </div>
        <div class="row mb-3">
          <div class="col-6 col-md-4 col-lg-3">
            <label for="imagem" class="form-label">Imagem</label>
            <input type="file" class="form-control border border-primary" id="imagem" name="imagem" accept="image/*" required>
          </div>
        </div>
        <div class="row mb-4">
          <div class="col-auto">
